			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="{{route('trang-chu')}}"><i class="fa fa-home"></i> 90-92 Lê Thị Riêng, Bến Thành, Quận 1</a></li>
						<li><a href="{{route('trang-chu')}}"><i class="fa fa-phone"></i> 0163 296 7751</a></li>
					</ul>
				</div>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									...
									<a class="cart-item-delete" href="{{route('xoasanpham',$product['item']['id'])}}"><i class="fa fa-times"></i></a>
									<div class="media">
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">${{$totalPrice or ''}}</span></div>
									<div class="clearfix"></div>
