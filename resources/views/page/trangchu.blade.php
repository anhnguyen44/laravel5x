					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($new_product)}} news products</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$pro->id)}}"><img src="source/image/product/{{$pro->image}}" alt="" height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
							<h4>Top Products</h4>
							<div class="beta-products-details">
								<p class="pull-left">{{count($top_product)}} top product</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								@foreach($top_product as $pro)
								<div class="col-sm-3">
									<div class="single-item">
										@if($pro->promotion_price>0)
										<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
